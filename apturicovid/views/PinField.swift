// Inspired by: https://github.com/kirualex/KAPinField

import UIKit

// MARK: - PinFieldDelegate
public protocol PinFieldDelegate : AnyObject {
    func pinField(_ field: PinField, didChangeTo string: String, isValid: Bool) // Optional
    func pinField(_ field: PinField, didFinishWith code: String)
}

public extension PinFieldDelegate {
    func pinField(_ field: PinField, didChangeTo string: String, isValid: Bool) {}
}

public struct PinFieldProperties {
    public weak var delegate : PinFieldDelegate? = nil
...
public struct PinFieldAppearance {
    public var font : MonospacedFont? = .menlo(40)
...
// MARK: - PinField Class
open class PinField : UITextField {
    
    // MARK: - Public vars
    
    open override var textContentType: UITextContentType? {
           get{ invisibleField.textContentType }
           set{ invisibleField.textContentType = newValue}
       }
    
    public var properties = PinFieldProperties() {
        didSet {
            self.reload()
        }
    }
    public var appearance = PinFieldAppearance() {
        didSet {
    ...
    private (set) var invisibleField = UITextField()
